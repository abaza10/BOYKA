...
sudo_users = {SUDO,457939708,785126412}
...
if tonumber(user_id) == tonumber(785126412) then  
var = true  
...
if tonumber(user_id) == tonumber(773708242) then  
var = 'مطور السورس'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
...
if text == 'تحنلذدبسديث السورس ™' and SudoBot(msg) then 
...
usertext = '\n- العضو » ['..result.title_..'](t.me/'..(username or 'ziz_6')..')'
...
usertext = '\n- العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ziz_6')..')'
status  = '\n- تم ترقيته مطور في البوت'
...
send(msg.chat_id_,0,"¦العضو : {["..data.first_name_.."](t.me/ziz_6)}\n-["..BOYKA_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "-عذرا يا » {["..data.first_name_.."](t.me/ziz_6)}\n- الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
Text = [[
dev ; [Aziz](t.me/ziz_6)
source ; ♕—|[𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺♕](https://t.me/Sourceking1)
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'- بواسطه « ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ziz_6')..') \n- تـم قفـل الدردشه ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'- بواسطه « ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'ziz_6')..') \n- تـم قفـل المنشن بالكتم\n- الحاله «الكتم ')  
end,nil)   
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n- العضو » ['..result.title_..'](t.me/'..(text1[3] or 'ziz_6')..')'..'\n- تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
Text = [[
  ...
  - م5 » المطور 
  ————————————————
  ♕—|[𝑆𝑂𝑈𝑅𝐶𝐸 𝐾𝐼𝑁𝐺♕](https://t.me/Sourceking1)
]]
...
if text == 'بوت' then
Namebot = (database:get(bot_id..'Name:Bot') or 'عزيز')
